...
public:
    ...
    virtual void putBitmap(const FT_Bitmap &bitmap) = 0;
...
public:
    void blit(compat::Pixel32* dst, const IDims2& dDims, const compat::Vector2i& offset) const override;
    ...
    void putBitmap(const FT_Bitmap &bitmap) override;
